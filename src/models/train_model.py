...
def main():
    ...
    try:
        ...
        print('(!) Error in train_model.load_config:{}'.format(str(exception_msg)))
    ...
    try:
        ...
        print('(!) Error in train_model.initialize_logger:{}'.format(str(exception_msg)))
    ...
    try:
        ...
        print('(!) Error in train_model.loading_data:{}'.format(str(exception_msg)))
    ...
    src.utils.utils.calculate_classification_metrics(y_hat=y_hat,
                                                     y_test=y_test,
                                                     logger=logger)
    ...
    src.utils.utils.save_model(model=model,
