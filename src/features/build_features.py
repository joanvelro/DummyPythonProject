...
# -*- coding: utf-8 -*-
"""
.. module:: Build Features
   :synopsis: This script builds up the processed data set. Extract coordinates and split in two columns
    Product a filter by locations.
...
try:
    ...
    df = src.data.data_processing.load_data(path=data_path + 'raw\\' + raw_file, logger=logger)
